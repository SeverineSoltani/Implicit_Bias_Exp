...
def JsonToCSV(jsn):
   csvTrialKeys = ['Task', 'Trial_Type', 'IATOrder', 'SmileCross', 'Congruence', 'Race', 'Gender', 'ShownFace', 'FacesRound', 'PostiveWord', 'NegativeWord', 'Catch_Trial', 'Response', 'WasCorrect', 'Response_Time', 'Stimulus_Onset', 'Actual_Response_time']
   csv = ['','']
...
if "is_participant_info" in input_data:
    ...
    if result:
       ...
       if "00000000" in input_data["userid"].value:
          ...
          json_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/Demo_Data/" + input_data["sc"].value + ".txt",'w')
          json_file.write(input_data["Responses"].value)
          json_file.close()
          csv_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/Demo_Data/" + input_data["sc"].value + ".csv",'w')
          ...
          json_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/Lab_Group/" + cond_group + input_data["sc"].value + ".txt",'w')
          json_file.write(input_data["Responses"].value)
          json_file.close()
          csv_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/Lab_Group/" + cond_group + input_data["sc"].value + ".csv",'w')
          csv_file.write(JsonToCSV(input_data["Responses"].value))
          csv_file.close() 
    	  
       else:
          print '<head><title>Thank you</title><link href="jspsych-6.1.0/css/jspsych.css" rel="stylesheet" type="text/css"></link></head><body style="margin: 0px; height: 100%; width: 100%;" tabindex="0" class="jspsych-display-element"><div style="display:table;width:100%;height:100%;"><div style="display:table-cell;vertical-align:middle;text-align:center;"><h3>Thank you! <br>Your responses are recorded; <a href="https://ucsd.sona-systems.com/webstudy_credit.aspx?experiment_id=1904&credit_token=c141fc1674c44334bc4a9e79882e3823&survey_code=' + input_data["sc"].value +'">please click on this link to receive your credit.</a></h3></div></div></body></html>'   
          cond_group = "Cond_" + input_data["condGroup"].value + "/"
          json_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/JSON_Data/" + cond_group + input_data["sc"].value + ".txt",'w')
          json_file.write(input_data["Responses"].value)
          json_file.close()
          csv_file = open("/home/websites/yulabexp-face/IAT_Individuation/RecRes/CSV_Data/" + cond_group + input_data["sc"].value + ".csv",'w')
          csv_file.write(JsonToCSV(input_data["Responses"].value))
          csv_file.close() 
